document.addEventListener('DOMContentLoaded', () => {
    ...
    downloadBtn.onclick = () => {
        ...
        const headerRows = [
            ...
            ["", "PASILLO Nº 2 🛒 DE FERIA DEL ESTE 🛒", "", ""],
            ["", "FECHA", dateStr, ""],
        ...
        // Filename: Pasillo 2 - [Responsable]
        XLSX.writeFile(workbook, `Pasillo 2 - ${respName.toUpperCase()}.xlsx`);
    };
    ...
    let assistantRole = sessionStorage.getItem('assistantRole_P2') || "SIN ASIGNAR";
        ...
        helperBtn.onclick = () => {
            ...
            if (role) {
                ...
                if (helperName) {
                    ...
                    sessionStorage.setItem('assistantRole_P2', assistantRole);
            ...
            if (confirm("¿Está seguro de que desea limpiar todos los datos de este pasillo?")) {
                ...
                if (clave === "085030140") {
                    if (confirm("TEN EN CUENTA QUE SE BORRARA TODO. ¿Proceder?")) {
                        ...
                        sessionStorage.removeItem('assistantRole_P2');
                        sessionStorage.setItem('inventoryData', JSON.stringify(inventoryData));
                        renderTable();
